...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    //Metodo que lo que hace es cargar la consulta en otra tabla 
    public void cargarConsultaTabla(){
        
        Agregar aconsulta = new Agregar();
        Consultar consul=new Consultar();
        Object o[] = null;
        
        for(int i=0;i<aconsulta.agendaNormal.size();i++){
            Contacto cto=(Contacto) consul.Consulta();
            
         
           /* cto=(Contacto) consul.Consulta();*/
            M.addRow(o);
            M.setValueAt(cto.getNombre(), i, 0);
            M.setValueAt(cto.getNumero(), i, 1);
        }
